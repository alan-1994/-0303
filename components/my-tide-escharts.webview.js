...
var z=gz$gwx_XC_3_1()
var cZB=_mz(z,'view',['class',0,'hidden',1],[],e,s,gg)
var h1B=_mz(z,'l-echart',['bind:__l',2,'bind:finished',1,'class',2,'data-event-opts',3,'data-ref',4,'vueId',5],[],e,s,gg)
_(cZB,h1B)
_(r,cZB)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/my-tide-escharts.wxss'] = setCssToHead([".",[1],"my-tide-escharts{height:100%;width:100%}\n",],undefined,{path:"./components/my-tide-escharts.wxss"});
}